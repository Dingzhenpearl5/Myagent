...
def _query_terms(query: str) -> list[str]:
    ...
    aliases = {
        "请假": ["年假", "病假", "事假", "审批"],
        "请假制度": ["请假", "年假", "病假", "事假", "审批"],
        "报销": ["费用", "发票", "财务", "差旅", "打款", "到账", "审批"],
        "报销制度": ["报销", "费用", "发票", "财务", "差旅", "打款", "到账"],
        "报销流程": ["报销", "费用", "发票", "财务", "审批", "打款", "到账"],
        "到账": ["报销", "财务", "审批", "打款", "5 个工作日"],
        "发票": ["报销", "电子发票", "支付凭证", "票据"],
        "差旅": ["报销", "交通费", "酒店", "出差"],
        "打卡": ["考勤", "补卡", "迟到", "上班打卡", "下班打卡"],
        "打卡制度": ["打卡", "考勤", "补卡", "迟到", "早退", "未打卡"],
        "考勤": ["打卡", "补卡", "迟到", "早退", "出勤", "弹性考勤", "异常考勤"],
        "考勤制度": ["考勤", "打卡", "补卡", "迟到", "早退", "出勤", "异常考勤"],
        "补卡": ["打卡", "考勤", "未打卡", "系统故障", "忘记打卡"],
        "迟到": ["考勤", "弹性考勤", "异常考勤"],
        "居家": ["远程", "居家办公"],
        "居家办公": ["居家", "远程", "线上会议"],
        "内部资料": ["员工手册", "公司制度", "考勤", "请假", "报销", "信息安全"],
        "员工手册": ["工作时间", "考勤", "请假", "报销", "居家办公", "信息安全", "绩效", "培训", "离职"],
        "ai": ["AI", "AI 工具", "信息安全", "敏感", "脱敏", "客户隐私", "密钥", "Token"],
        "ai工具": ["AI", "AI 工具", "信息安全", "敏感", "脱敏", "客户隐私"],
        "信息安全": ["AI", "AI 工具", "敏感信息", "客户数据", "账号权限", "API Key", "Token"],
        "敏感": ["信息安全", "客户隐私", "商业机密", "账号密钥", "敏感财务数据"],
        "密钥": ["信息安全", "账号密钥", "API Key", "Token"],
        "token": ["信息安全", "访问 Token", "API Key", "账号密钥"],
    }
    expanded = list(terms)
    for term in terms:
